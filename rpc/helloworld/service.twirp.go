...
func (c *helloWorldProtobufClient) Hello(ctx context.Context, in *HelloRequest) (*HelloResponse, error) {
...
func (c *helloWorldJSONClient) Hello(ctx context.Context, in *HelloRequest) (*HelloResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twirp.example.helloworld")
	ctx = ctxsetters.WithServiceName(ctx, "HelloWorld")
	ctx = ctxsetters.WithMethodName(ctx, "Hello")
	out := new(HelloResponse)
